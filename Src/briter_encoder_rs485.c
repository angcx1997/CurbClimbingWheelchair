...
/** briter_encoder_rs485 function type
 */
typedef enum {
 ...
 * @{
 */
static void Encoder_Send_Construct(Encoder_TX_u *txbuf, RS485_Enc_Func_e func, uint16_t own_addr, uint16_t send_addr, uint16_t read_byte);
 ...
 * @retval none
 */
static void Encoder_Send_Construct(Encoder_TX_u *txbuf, RS485_Enc_Func_e func, uint16_t own_addr, uint16_t send_addr, uint16_t send_value) {
