...
static void MX_GPIO_Init(void) {
    ...
    HAL_GPIO_WritePin(GPIOC, AD_RANGE_Pin | AD_OS2_Pin | AD_OS1_Pin | AD_OS0_Pin | AD_RST_Pin | AD_CV_Pin,
	    GPIO_PIN_RESET);
    ...
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOB, ClimbM_IO_FR2_Pin | ClimbM_IO_EN2_Pin | LED1_Pin | LED2_Pin | Buzzer_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOE, ClimbM_IO_BRK2_Pin | ClimbM_IO_FR1_Pin | ClimbM_IO_EN1_Pin | ClimbM_IO_BRK1_Pin,
	    GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOD,
    CUI_SPI2_CS1_Pin | CUI_SPI2_CS2_Pin | HubM_IO_SON_Pin | HubM_IO_NOT_Pin | HubM_IO_POT_Pin | Brake_Wheel_Pin,
	    GPIO_PIN_RESET);
    ...
    /*Configure GPIO pins : LimitSW1_Pin LimitSW2_Pin LimitSW3_Pin LimitSW4_Pin
     ClimbM_IO_ALM2_Pin ClimbM_IO_ALM1_Pin */
    GPIO_InitStruct.Pin = LimitSW1_Pin | LimitSW2_Pin | LimitSW3_Pin | LimitSW4_Pin | ClimbM_IO_ALM2_Pin
	    | ClimbM_IO_ALM1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    ...
    GPIO_InitStruct.Pin = AD_RANGE_Pin | AD_OS2_Pin | AD_OS1_Pin | AD_OS0_Pin | AD_RST_Pin | AD_CV_Pin;
    ...
    /*Configure GPIO pins : ClimbM_IO_FR2_Pin ClimbM_IO_EN2_Pin LED1_Pin LED2_Pin
     Buzzer_Pin */
    GPIO_InitStruct.Pin = ClimbM_IO_FR2_Pin | ClimbM_IO_EN2_Pin | LED1_Pin | LED2_Pin | Buzzer_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    /*Configure GPIO pins : CUI_SPI2_CS1_Pin CUI_SPI2_CS2_Pin HubM_IO_SON_Pin HubM_IO_NOT_Pin
     HubM_IO_POT_Pin Brake_Wheel_Pin */
    GPIO_InitStruct.Pin = CUI_SPI2_CS1_Pin | CUI_SPI2_CS2_Pin | HubM_IO_SON_Pin | HubM_IO_NOT_Pin | HubM_IO_POT_Pin
	    | Brake_Wheel_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    /*Configure GPIO pin : HubM_IO_ALM_Pin */
